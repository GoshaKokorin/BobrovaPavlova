...
# TODO: Карточки цен
# TODO: Картинки сингл сервис
# TODO: Главная картинка проекта
# TODO: Картинки проекта на сингл сервис
...
class Projects(models.Model):
    ...
    description6 = models.CharField('Текст к заголовку 2', max_length=255, null=True)
    ...
    title7 = models.CharField('Текст к заголовку 3', max_length=255, null=True)
    title9 = models.CharField('Заголовок 4', max_length=255, null=True)
    title10 = models.CharField('Текст к заголовку 4', max_length=255, null=True)
